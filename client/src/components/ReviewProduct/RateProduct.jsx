        ...
        >
          <div>
            <img
              ...
              src={adminsProduct.product?.imageUrl}
              alt=""
            />
          </div>
          <div className="ml-3 lg:ml-5 space-y-2 lg:space-y-4">
            <p className="lg:text-lg">{adminsProduct.product?.title}</p>
            <p className="opacity-50 font-semibold">
              {adminsProduct.product?.brand}
            </p>
            <p>₹{adminsProduct.product?.price}</p>
            <p>Size: Free</p>
           {adminsProduct.product?.color && <p>Color: {adminsProduct.product?.color}</p>}

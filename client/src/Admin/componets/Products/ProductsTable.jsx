...
import { getProducts ,deleteProduct,findProductById} from '../../../Redux/Admin/Product/Action'; // Assuming you have a getAllProducts action creator
...
const ProductsTable = () => {
  ...
  }, [availability, category, sort, page, adminsProduct.deleteProduct]);
          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                value={filterValue.category || ''} // Ensure value is not null
                label="Category"
          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                value={filterValue.availability || ''} // Ensure value is not null
                label="Availability"
          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                value={filterValue.sort || ''} // Ensure value is not null
                label="Sort By Price"

...
import { getProducts, deleteProduct, findProductById } from '../../../Redux/Admin/Product/Action';
...
export default function Product() {
    ...
    const handleClick = (itemId) => {
        navigate(`/product/${itemId}`); // Assuming product id is used in the URL
    };
    return (
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                                                ...
                                                <>
                                                    <h3 className="-my-3 flow-root">
                                                        <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                                                            <FormLabel sx={{ color: 'black', fontSize: '1rem' }} id="demo-radio-buttons-group-label">{section.name}</FormLabel>
                            ...
                            <div className="lg:col-span-4 w-full">
                                <div className='flex flex-wrap justify-center bg-white py-5 '>
                                    {adminsProduct?.products?.content?.map((item) => (
                                        <div onClick={() => handleClick(item._id)} className='productcard w-[15rem] transition-all cursor-pointer flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden mx-3 my-4 border'>
                            ...
                            <div className="lg:col-span-4 w-full">
                                <div className='flex flex-wrap justify-center bg-white py-5 '>
                                    {Babycare.map((item) => <ProductCard product={item} />)}
                                </div>
                            </div>
                            <div className="lg:col-span-4 w-full">
                                <div className='flex flex-wrap justify-center bg-white py-5 '>
                                    {Womenshygiene.map((item) => <ProductCard product={item} />)}
                                </div>
                            </div>
                            <div className="lg:col-span-4 w-full">
                                <div className='flex flex-wrap justify-center bg-white py-5 '>
                                    {Veterinary.map((item) => <ProductCard product={item} />)}
                                </div>
                            </div>
                        </div>
                    </section>
